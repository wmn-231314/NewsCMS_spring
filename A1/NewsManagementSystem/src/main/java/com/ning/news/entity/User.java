...
public class User {
    ...
    public User(UserParam userParam){
        if(userParam.getAccount() != null) this.account = userParam.getAccount();
        if(userParam.getPassword() != null) this.password = userParam.getPassword();
        if(userParam.getName() != null) this.name = userParam.getName();
        if(userParam.getPermission() != null) this.permission = userParam.getPermission();
    }
