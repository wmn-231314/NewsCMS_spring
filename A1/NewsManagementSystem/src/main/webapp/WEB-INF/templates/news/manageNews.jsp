...
<head>
    <meta charset="UTF-8">
    <title th:text="${user.getName()}+'\'s article'">'s articles</title>
        ...
        <div class="col-md-12">
            <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                    ...
                    <strong class="d-inline-block mb-2 text-secondary" th:text="${news.getStatus()}">Modifying</strong>
                    ...
                    <div class="btn-group">
                        <a th:href="@{viewNewsDetailById/}+${news.getId()}" type="button" class="btn btn-sm btn-outline-secondary">View</a>
                        <a type="button" class="btn btn-sm btn-outline-secondary" th:href="@{editNews/}+${news.getId()}">Edit</a>
                        <a type="button" class="btn btn-sm btn-outline-secondary" th:href="@{deleteVerify/}+${news.getId()}">Delete</a>
                    </div>
                </div>
            </div>
        </div>
