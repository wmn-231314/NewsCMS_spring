        ...
        <div class="row-cols-1">
            <div class="mb-3">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" id="title" th:name="title" placeholder="Title" required th:value="${news.getTitle()}">
            ...
            <div class="mb-3">
                ...
                <select class="custom-select d-block w-100" id="category" th:name="categoryId" required>
                    ...
                    <div th:each="category:${categories}">
                        <option th:unless="${category.getId()} == ${news.getCategoryId()}" th:text="${category.getCategoryName()}" th:value="${category.getId()}">Others</option>
                        <option th:if="${category.getId()} == ${news.getCategoryId()}" th:text="${category.getCategoryName()}" th:value="${category.getId()}" selected>Others</option>
                    </div>
                </select>
            ...
            <div class="mb-3">
                ...
                <select class="custom-select d-block w-100" id="reviewer" name="reviewerId" th:name="reviewerId" required>
                    ...
                    <div th:each="reviewer:${reviewers}">
                        <option th:text="${reviewer.getName()}+' '+${reviewer.getAccount()}" th:value="${reviewer.getId()}" th:if="${reviewer.getId()} != ${session.user.getId()} and ${reviewer.getId()} != ${news.getReviewerId()}">Others</option>
                        <option th:text="${reviewer.getName()}+' '+${reviewer.getAccount()}" th:value="${reviewer.getId()}" th:if="${reviewer.getId()} != ${session.user.getId()} and ${reviewer.getId()} == ${news.getReviewerId()}" selected>Others</option>
                    </div>
                </select>
                <div class="invalid-feedback">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" type="text" id="content" th:name="content" placeholder="Please input something..." rows="10" required
