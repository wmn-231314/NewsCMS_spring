    ...
    <div class="row">
        ...
        <aside class="col-md-4 blog-sidebar pt-lg-5">
            <div class="p-4 mb-3 bg-light rounded">
                <h4 class="font-italic">Feedback</h4>
                <p class="mb-0" th:if="${feedback} == null">Nothing.</p>
                <p class="mb-0" th:unless="${feedback} == null" th:text="${#strings.unescapeJava(#strings.replace(#strings.escapeJava(feedback),'\n','&lt;br/&gt;'))}">Nothing.</p>
            </div>
        </aside><!-- /.blog-sidebar -->
    </div>
</main><!-- /.container -->
