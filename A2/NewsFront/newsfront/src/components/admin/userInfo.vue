                ...
                <ul class="layui-nav layui-nav-tree" lay-filter="test">
                    <li class="layui-nav-item layui-nav-itemed">
                        ...
                        <dl class="layui-nav-child">
                            ...
                            <dd class="layui-nav-itemed"><a th:href="@{userInfo}">用户管理</a></dd>
...
import AdminFooter from "../fragments/adminFooter.vue";
import AdminHeader from "../fragments/adminHeader.vue";
